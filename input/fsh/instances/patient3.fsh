...
* telecom[=].use = #work
* gender = #female
* birthDate.extension[+].url = "https://www.ehealth.fgov.be/standards/fhir/infsec/StructureDefinition/be-ext-pseudonymized-content"
* birthDate.extension[=].extension[+].url = "encryptedValue"
* birthDate.extension[=].extension[=].valueString = "urn:be:fgov:pseudo-encrypted:v1:fcc557e7-40fa-4fde-b802-12a461cd176f:MTk3OS0xMi0xMQoAAAAAAAAAAA=="
* birthDate.extension[=].extension[+].url = "marker"
* birthDate.extension[=].extension[=].valueBoolean = true
* birthDate.extension[=].extension[+].url = "format"
* birthDate.extension[=].extension[=].valueCode = #encrypted
* birthDate.extension[=].extension[+].url = "version"
* birthDate.extension[=].extension[=].valuePositiveInt = 1
